...
I am a software developer with experience in Python, JavaScript, React, SQL, REST APIs, and web application development. I have projects involving databases, APIs, software testing, automation, and full-stack applications. I am looking to contribute in issues related to backend development, APIs, testing, debugging, or data handling. I am also interested in improving my experience with Python, TypeScript, modern web frameworks, and AI/ML-related applications. I prefer issues that can be worked on independently with a clear scope, and I would like to avoid issues that require knowledge on technologies that I have never worked with.
